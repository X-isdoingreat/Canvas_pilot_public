...
- The canonical public website moved to
  `https://canvas-pilot-rho.vercel.app/install`; landing, setup, documentation,
  social metadata, sitemap, robots, llms, and publishing-source links now use
  the Vercel identity. The previous custom-domain alias remains online only
  during migration.
